import {
  ...
  QueryClientProvider,
  img
} from "./chunk-ETW7JNPL.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-JWMTT2XL.js";
import {
  useNpsSurveySettings
} from "./chunk-VX3FTVHI.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-YY6ENHZ7.js";
import {
  useGetAIUsageQuery
} from "./chunk-OYLX4QKN.js";
import {
  require_pick
} from "./chunk-6RHTUQAA.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-2ZX65DNJ.js";
import {
  useEnterprise
} from "./chunk-SFG4P6IC.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-T2BWJKB5.js";
import {
  Login
} from "./chunk-Y433LVGQ.js";
import {
  MemoizedInputRenderer
} from "./chunk-KKMCHAYE.js";
import {
  Form
} from "./chunk-YTYUWOXU.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-PWH2L345.js";
import {
  ConfigurationProvider
} from "./chunk-YG5U2KNW.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-GE47D6ZI.js";
import {
  require_baseRest
} from "./chunk-UAZQQ5KM.js";
import {
  HistoryProvider
} from "./chunk-7RI3MVC4.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-BIJR5S5Y.js";
import {
  Layouts
} from "./chunk-O24C6WOD.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-AXP2LH3K.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-COVYGB6N.js";
import {
  getByteSize
...
import {
  require_isEqual
} from "./chunk-T5LMVEOE.js";
import {
  ForwardRef$k,
  Page,
  useAPIErrorHandler
} from "./chunk-T2A3GXKZ.js";
import {
  AuthProvider,
  StrapiAppProvider,
  getOrCreateDeviceId,
...
} from "./chunk-CJSJGF7J.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-36VTO7MP.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-B34LZQNJ.js";
import {
...
import {
  ...
  isRejected,
  useDispatch
} from "./chunk-CMRXJNKW.js";
import {
  require_isFunction,
  require_isObject,
  require_root
} from "./chunk-Z4B7BWH2.js";
import {
  L
} from "./chunk-M2GFLGLC.js";
import {
  Alert,
  Box,
  Button,
  ...
  provider_default,
  useIntl
} from "./chunk-TQ76WLDG.js";
import {
  require_client
} from "./chunk-OKE5K77U.js";
import {
  Link,
  NavLink,
  Navigate,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-OBLHC47B.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-ARH2VHTT.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-RKHZTCRX.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-TTACYGBD.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ZJ7CVQTG.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-QJRUMUIM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-MFTRNAPC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UKFU2PSI.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-JE2SKSH4.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-ONYW5GHL.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-62LSGDAW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-HHFRI4O4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-Z3D3FS6W.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-PVWCTYCX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-VVXDA5ES.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-FFF755D5.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-TD474FEN.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-REXCWDYP.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-32ZYX3RW.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-YTE6OPT7.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-2YNJUVEB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-XXLE3JTK.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-LX3S5NZD.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-A7LV6LL6.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-PWZSYQIO.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-KH5Y4O3P.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-63DMWYYP.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-6P6M6I7K.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-BJ2E3WUS.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-N244QJDV.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-N244QJDV.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-KHFGE2R5.js");
...
//# sourceMappingURL=chunk-P7JLLDWG.js.map
